...
class Notification(models.Model):
    class NotificationType(models.TextChoices):
        ...
        SHARED_RIDE_JOINED = 'shared_ride_joined', 'Shared Ride Joined'
        SHARED_RIDE_CONFIRMED = 'shared_ride_confirmed', 'Shared Ride Confirmed'
        SHARED_RIDE_DISPATCHED = 'shared_ride_dispatched', 'Shared Ride Dispatched'
        SHARED_RIDE_CANCELLED = 'shared_ride_cancelled', 'Shared Ride Cancelled'
