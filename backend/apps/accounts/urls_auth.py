...
urlpatterns = [
    ...
    path('settings/pin/reset/request/', PinResetRequestOTPView.as_view(), name='auth-settings-pin-reset-request'),
    path('settings/pin/reset/confirm/', PinResetConfirmView.as_view(), name='auth-settings-pin-reset-confirm'),
