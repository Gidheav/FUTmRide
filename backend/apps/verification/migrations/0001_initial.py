    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_type', models.CharField(choices=[('national_id', 'National ID'), ('drivers_license', "Driver's Licence"), ('vehicle_registration', 'Vehicle Registration'), ('vehicle_insurance', 'Vehicle Insurance'), ('profile_photo', 'Profile Photo'), ('vehicle_photo', 'Vehicle Photo')], max_length=30)),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['driver', 'status'], name='driver_docu_driver__94aa68_idx')],
