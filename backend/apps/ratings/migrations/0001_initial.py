    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_type', models.CharField(choices=[('student_to_driver', 'Student to Driver'), ('driver_to_student', 'Driver to Student')], max_length=20)),
            ...
            options={
                'db_table': 'ratings',
                'indexes': [models.Index(fields=['ratee', 'rating_type'], name='ratings_ratee_i_96ad8f_idx'), models.Index(fields=['ride'], name='ratings_ride_id_e21d9a_idx')],
