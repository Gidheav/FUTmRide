...
from .views import (
    ...
    StudentConfirmRideCompletionView,
    StudentDisputeRideCompletionView,
    RideDetailView,
    CancelRideView,
...
from .scheduled_bus_views import (
    ...
    DriverPassengerListView,
    DriverPassengerUpdateView,
...
urlpatterns = [
    ...
    path('<uuid:ride_id>/confirm-completion/', StudentConfirmRideCompletionView.as_view(), name='ride-confirm-completion'),
    path('<uuid:ride_id>/dispute-completion/', StudentDisputeRideCompletionView.as_view(), name='ride-dispute-completion'),
    ...
    path('test-tools/rides/flush/', TestToolFlushRidesView.as_view(), name='test-tools-rides-flush'),
