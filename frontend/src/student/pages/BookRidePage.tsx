...
import { ArrowLeft, MapPin, Navigation, Car, Bike, ArrowRight, ChevronDown } from 'lucide-react'
import api from '../../core/api'
import { useAuthStore } from '../../core/authStore'

const schema = z.object({
  pickup_address: z.string().min(3, 'Enter a pickup location'),
  pickup_latitude: z.string().min(1, 'Required'),
  pickup_longitude: z.string().min(1, 'Required'),
  dropoff_address: z.string().min(3, 'Enter a destination'),
  dropoff_latitude: z.string().min(1, 'Required'),
  dropoff_longitude: z.string().min(1, 'Required'),
  vehicle_type_requested: z.enum(['motorcycle', 'tricycle', 'sedan', 'suv', 'minivan']),
...
const VEHICLES = [
  { value: 'motorcycle', label: 'Motorcycle', desc: 'Fast, solo ride', fare: '₦250+' },
  { value: 'tricycle',   label: 'Keke',       desc: 'Shared / short trips', fare: '₦350+' },
  { value: 'sedan',      label: 'Sedan',      desc: 'Comfortable, up to 4', fare: '₦600+' },
  { value: 'suv',        label: 'SUV',        desc: 'Spacious, up to 6', fare: '₦800+' },
  { value: 'minivan',    label: 'Shuttle',    desc: 'Group travel', fare: '₦700+' },
]

const LOCATIONS = [
  { label: 'Gidan Kwano Main Gate', lat: '9.0820', lng: '7.4891' },
  { label: 'FUTMINNA Library', lat: '9.0750', lng: '7.4800' },
  { label: 'School of Engineering', lat: '9.0780', lng: '7.4820' },
  { label: 'Student Affairs', lat: '9.0760', lng: '7.4810' },
  { label: 'Staff Quarters', lat: '9.0800', lng: '7.4870' },
  { label: 'Bosso Campus', lat: '9.0650', lng: '7.4700' },
  { label: 'Minna Town Centre', lat: '9.0600', lng: '7.4600' },
]
