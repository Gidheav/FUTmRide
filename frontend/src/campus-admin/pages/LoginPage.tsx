...
const css = '@import url(https://fonts.googleapis.com/css2?family=Instrument+Sans:wght@400;500;600;700&family=Instrument+Serif:ital@0;1&display=swap);' +
  ...
  'body { background: #0e1a2a; font-family: Instrument Sans, sans-serif; }' +
  ...
  '.card-title { font-family: Instrument Serif, serif; font-size: 30px; color: #0f172a; letter-spacing: -0.7px; margin-bottom: 6px; }' +
  ...
  '.field-input { width: 100%; height: 48px; padding: 0 42px 0 14px; background: #f8fafc; border: 1.5px solid #dbe2ea; border-radius: 10px; font-family: Instrument Sans, sans-serif; font-size: 14px; color: #0f172a; outline: none; transition: border-color 0.15s; box-sizing: border-box; }' +
  '.field-input:focus { border-color: #0f766e; }' +
  '.field-input::placeholder { color: #94a3b8; }' +
  '.input-wrap { position: relative; }' +
  '.show-btn { position: absolute; right: 0; top: 0; height: 48px; width: 44px; display: flex; align-items: center; justify-content: center; background: none; border: none; cursor: pointer; color: #64748b; font-size: 11px; font-weight: 700; text-transform: uppercase; font-family: Instrument Sans, sans-serif; transition: color 0.15s; }' +
  '.show-btn:hover { color: #0f766e; }' +
  '.field-error { color: #dc2626; font-size: 12px; margin-top: 5px; }' +
  '.submit-btn { width: 100%; height: 50px; background: #0f766e; border: none; border-radius: 10px; color: #fff; font-family: Instrument Sans, sans-serif; font-size: 14px; font-weight: 700; cursor: pointer; margin-top: 6px; transition: background 0.2s; }' +
