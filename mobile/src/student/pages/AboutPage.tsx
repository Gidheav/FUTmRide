...
export default function AboutPage() {
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>About TESSERA</Text>
      ...
      <Text style={styles.text}>
        TESSERA is the student mobile application for requesting rides, tracking trips, managing wallet payments, and staying connected to campus transport operations.
      </Text>
      <Text style={styles.text}>
